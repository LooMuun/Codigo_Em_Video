...
const Login = () => {
  ...
  const handleGithubLogin = async () => {
    ...
    try {
      ...
      // Supabase will perform a redirect to GitHub; after auth it will redirect back
    } catch (err) {
      console.error(err);
      setError("Erro ao iniciar sessão com GitHub.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="auth-page">
      ...
      {/* card grande único: form (esq) + onda azul (dir) */}
      <div className="login-card fade-in-container">
        ...
        {/* ── LADO DIREITO: imagem de fundo + logo centralizada ── */}
        <div className="card-right">
          <img
            src={meshGradient}
            alt=""
            className="card-right-bg"
          />
