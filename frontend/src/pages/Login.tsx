...
const Login = () => {
  ...
  const handleGithubLogin = async () => {
    ...
    try {
      ...
      console.error(err);
      setError(getUserFriendlyError(err, "social-login"));
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="login-card fade-in-container">
        <div className="card-left">
          ...
          <form className="auth-form" onSubmit={handleLogin}>
              ...
              <ButtonLoading isLoading={isLoading} className="btn-primary" type="submit">
                Login
              </ButtonLoading>
              ...
              <ButtonLoading isLoading={isLoading} type="button" className="btn-social" onClick={handleGithubLogin}>
              ...
              <ButtonLoading isLoading={isLoading} type="button" className="btn-social" onClick={handleGoogleLogin}>
              ...
              <button type="button" className="btn-social" onClick={() => navigate("/dashboard")}>
        ...
        <div className="card-right">
          ...
          <div className="card-right-content">
            ...
            <p className="brand-big-name">
              <span className="brand-highlight">CODIGO</span> EM VIDEO
            </p>
          </div>
          <p className="card-copyright">2026 Codigo em Video - Todos os direitos reservados</p>
        </div>
      </div>
    </div>
  );
