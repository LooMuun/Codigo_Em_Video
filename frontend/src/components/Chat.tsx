...
const Chat = ({ isOpen = true, onClose }: ChatProps) => {
    ...
    // 3. NOVA FUNÇÃO: Trata a ação de voltar
    const handleVoltar = () => {
    navigate("/dashboard"); 
};
    ...
    const handleEnviar = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            setMensagens(prev => [...prev, {
                id: prev.length + 1,
                texto: "Essa é uma resposta automática do Cody simulando a integração com o back!",
    ...
    return (
        <div className="fullscreen-chat-container">
            ...
            <div className="chat-topbar">
                {/* 4. ATUALIZADO: Evento onClick adicionado aqui */}
            ...
            {/* ... restante do componente (mensagens, formulário e dropdown) continua idêntico ... */}
            {mensagens.length === 0 ? (
                    ...
                    <div className="attach-button-container">
                        {isMenuOpen && (
                            <div className="attach-dropdown-menu">
                                ...
                                <button type="button" className="dropdown-item">
                                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
